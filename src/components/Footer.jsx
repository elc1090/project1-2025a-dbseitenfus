...
export default function Footer() {
    ...
    return (
        <footer className="mt-5">
            <div className="bg-blue-strong w-full text-white p-7 flex justify-between items-center">
                ...
                <Button className="bg-orange-weak w-[200px] h-[50px] ml-40 ml-10">
                    CADASTRAR
                </Button>
                
            </div>
            <div className="bg-blue-footer w-full flex text-white p-7">
            ...
            <div className="bg-blue-strong w-full  p-8 flex flex-col justify-center items-center text-white"> 
